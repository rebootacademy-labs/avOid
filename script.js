function MainDot () {
  this.dot = document.getElementById("personaje");  
  ...
  this.move = function() {
    ...
    canvas.addEventListener("mousemove", function (e) {
      ...
      /*
      var sumRadios = that.dot.offsetWidth / 2 + enemy[0].offsetWidth / 2;
      var x = (dotLeft + (that.dot.offsetWidth / 2)) - (enemyLeft + (enemy[0].offsetWidth / 2));
      var y = (dotTop + (that.dot.offsetHeight / 2)) - (enemyTop + (enemy[0].offsetHeight / 2));
